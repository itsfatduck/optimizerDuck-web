  ...
  <footer v-if="footer && !hasSidebar" class="VPFooter">
    <div class="footer-container">
      <div class="footer-top">
        <div v-for="group in footer.navigation" :key="group.title" class="footer-group">
          <h4 class="footer-group-title">{{ group.title }}</h4>
          <ul class="footer-group-list">
            <li v-for="item in group.items" :key="item.text">
              <a :href="item.link" target="_blank" rel="noopener noreferrer" class="footer-link">
                {{ item.text }}
              </a>
            </li>
          </ul>
      ...
      <div class="footer-bottom">
        <div class="footer-license">
          <a v-if="footer.license" :href="footer.license.link" target="_blank" rel="noopener noreferrer"
            class="license-link">
            <img src="/gplv3.webp" alt="GPL-3.0 License" class="license-logo" loading="lazy" decoding="async" />
        ...
        <div v-if="footer.social || theme.socialLinks" class="footer-social">
          <a v-for="social in footer.social || theme.socialLinks" :key="social.link" :href="social.link" target="_blank"
            rel="noopener noreferrer" class="footer-social-link" :aria-label="social.name ||
            ...
            <img v-else :src="social.icon" :alt="social.name" class="social-icon-img" />
          </a>
        </div>
      </div>
    </div>
