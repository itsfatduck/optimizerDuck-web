...
[![Stars](https://img.shields.io/endpoint?url=https://api.pinstudios.net/api/badges/stars/itsfatduck/optimizerDuck-web)](https://github.com/itsfatduck/optimizerDuck-web/stargazers)
...
[optimizerDuck](https://github.com/itsfatduck/optimizerDuck) application is licensed under [GPL v3](https://github.com/itsfatduck/optimizerDuck/blob/master/LICENSE).<br>
This website/documentation is licensed under [MIT](./LICENSE).